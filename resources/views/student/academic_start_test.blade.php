        ...
        <div class="col">
            <div class="row type academic shadow bg-white py-5 mb-4">
                <div class="col text-center">
                    <h1>You have chosen the Academic test.</h1>
                    <a href="{{ route('studentDashboard') }}" class="next-button" data-next-step="one"><strong>Select a different
                        test</strong></a>
                </div>
            </div>
            <div class="row instructions shadow bg-white mb-4">
                ...
                <div class="col-12 col-md-6 py-5 px-4">
                    ...
                    <p>You will be able to match these with the Common European Framework of Reference for Languages (CEFR)
                        framework levels.</p>
                    <a href="{{route('academic.listening.confirm_details')}}" class="btn btn-primary next-button end">Start test</a>
                </div>
            </div>
        </div>
    </div>
