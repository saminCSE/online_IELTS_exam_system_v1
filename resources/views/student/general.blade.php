                                                            ...
                                                            <div class="modal-body text-center">
                                                                ...
                                                                <div class="container justify-content-center"
                                                                    ...
                                                                    <a class="iot-bt btn btn-danger"
                                                                        href="{{ route('reading_general', ['title_id' => $title_id, 'skills_id' => $skills_id]) }}"
                                                                        target="_blank">
                                                                        Start Now
                                                                    </a>
                                                                @elseif($skills_id === 5)
                                                                <div class="container justify-content-center"
                                                                    ...
                                                                    <a class="iot-bt btn btn-danger"
                                                                        href="{{ route('writing_general', ['title_id' => $title_id, 'skills_id' => $skills_id]) }}"
                                                                        target="_blank">
                                                                        Start Now
                                                                    </a>
                                                                @elseif($skills_id === 7)
                                                                <div class="container justify-content-center"
                                                                    ...
                                                                    <a class="iot-bt btn btn-danger"
                                                                        href="{{ route('listening_general', ['title_id' => $title_id, 'skills_id' => $skills_id]) }}"
                                                                        target="_blank">
                                                                        Start Now
                                                                    </a>
                                                                @endif
