...
(function ($) {
    var methods = {
        ...
        addRange: function (
            ...
            $(".jqyc-range-choosen-between").removeClass(
        ...
        if (methods[options]) {
            ...
            function showPreviousYear() {
                var currentYear = parseInt(
                    $(this).parent().parent().data("currentYear")
                );
                ...
                $calendar.find(".jqyc-next-year").on("click", showNextYear);
                $calendar
                    .find(".jqyc-not-empty-td")
                    .on("click", triggerDayChoose);
            ...
            function triggerDayChoose() {
                ...
                if (
                    ...
                    settings.minMonth != null &&
                    settings.minDay != null
                ) {
                    var date = new Date(choosenYear, choosenMonth, choosenDay);
                    if (parseInt(choosenYear) <= parseInt(settings.minYear)) {
                        if (
                            parseInt(choosenMonth) <
                                parseInt(settings.minMonth) ||
                            (parseInt(choosenMonth) ==
                                parseInt(settings.minMonth) &&
                                parseInt(choosenDay) <
                                    parseInt(settings.minDay))
                        ) {
                ...
                if (
                    ...
                    settings.maxMonth != null &&
                    settings.maxDay != null
                ) {
                    var date = new Date(choosenYear, choosenMonth, choosenDay);
                    if (parseInt(choosenYear) <= parseInt(settings.maxYear)) {
                        if (
                            parseInt(choosenMonth) <
                                parseInt(settings.maxMonth) ||
                            (parseInt(choosenMonth) ==
                                parseInt(settings.maxMonth) &&
                                parseInt(choosenDay) <
                                    parseInt(settings.maxDay))
                        ) {
                ...
                if (settings.mode == "rangepicker") {
                    if ($calendar.data("rangepicker-start-choosen") != true) {
                        $calendar.data(
                            "rangepicker-start-day-of-month",
                            choosenDay
                        );
                        ...
                        if (settings.maxDaysToChoose) {
                            ...
                            var daysBettweenDates = Math.round(
                                (startDate - endDate) / (1000 * 60 * 60 * 24)
                            );
                            if (
                                settings.maxDaysToChoose - 1 <
                                Math.abs(daysBettweenDates)
                            ) {
                                if (settings.maxDaysToChooseMessage) {
                                    alert(
                                        settings.maxDaysToChooseMessage +
                                            settings.maxDaysToChoose
                                    );
                                }
                                $(".jqyc-range-choosen-between").removeClass(
                                    "jqyc-range-choosen-between"
                                ...
                                $calendar.data(
                                    "rangepicker-end-day-of-month",
                                    false
                                );
                                $calendar.data("rangepicker-end-month", false);
                                $calendar.data("rangepicker-end-year", false);
                                $calendar.data(
                                    "rangepicker-end-choosen",
                                    false
                                );
                                $calendar.data(
                                    "rangepicker-start-day-of-month",
                                ...
                                $calendar.data(
                                    "rangepicker-start-month",
                                    false
                                );
                                $calendar.data("rangepicker-start-year", false);
                                $calendar.data(
                                    "rangepicker-start-choosen",
                                    false
                                );
                                return false;
                            }
                ...
                if (
                    settings.addUniqueClassOnClick &&
    ...
    function createWholeCalendar(settings, $this) {
        ...
        var domSkeleton =
            ...
            colColXs2 +
            ' text-left">' +
            '   <button type="button" class="btn btn-primary btn-sm jqyc-prev-year jqyc-change-year" data-year="' +
            (year - 1) +
            '">&larr;</button>' +
            "</div>" +
            '<div class="' +
            ...
            colColXs2 +
            ' text-right">' +
            '   <button type="button" class="btn btn-primary btn-sm jqyc-next-year jqyc-change-year" data-year="' +
            year +
            '">&rarr;</button>' +
            "</div>" +
            "</div>" +
            '<div class="jqyc-months mt-4">' +
            '<div class="jqyc-month jqyc-jan" data-month="1" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-feb" data-month="2" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-mar" data-month="3" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-apr" data-month="4" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-may" data-month="5" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-jun" data-month="6" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-jul" data-month="7" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-aug" data-month="8" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-sep" data-month="9" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-oct" data-month="10" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-nov" data-month="11" data-year="' +
            year +
            '"></div>' +
            '<div class="jqyc-month jqyc-dec" data-month="12" data-year="' +
            year +
            '"></div>' +
            "</div></div>";
        if (startFromSunday) {
        ...
        var results = jqycGetMonthHTMLStringWithData(
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-jan")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.jan + "</h5>"
                );
        }
        $html
            .find(".jqyc-jan")
            .append(tableSkeleton)
            .find("tbody")
            .append(monthHTMLString);
        var results = jqycGetMonthHTMLStringWithData(
            results.firstDayOfPreviousMonth,
            2,
            year,
            daysOfFeb
        );
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-feb")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.feb + "</h5>"
                );
        }
        $html
            .find(".jqyc-feb")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-mar")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.mar + "</h5>"
                );
        }
        $html
            .find(".jqyc-mar")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-apr")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.apr + "</h5>"
                );
        }
        $html
            .find(".jqyc-apr")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-may")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.may + "</h5>"
                );
        }
        $html
            .find(".jqyc-may")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-jun")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.jun + "</h5>"
                );
        }
        $html
            .find(".jqyc-jun")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-jul")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.jul + "</h5>"
                );
        }
        $html
            .find(".jqyc-jul")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-aug")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.aug + "</h5>"
                );
        }
        $html
            .find(".jqyc-aug")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-sep")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.sep + "</h5>"
                );
        }
        $html
            .find(".jqyc-sep")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-oct")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.oct + "</h5>"
                );
        }
        $html
            .find(".jqyc-oct")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-nov")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.nov + "</h5>"
                );
        }
        $html
            .find(".jqyc-nov")
        ...
        if (settings.showHeaders) {
            $html
                .find(".jqyc-dec")
                .append(
                    '<h5 class="jqyc-header">' + settings.l10n.dec + "</h5>"
                );
        }
        $html
            .find(".jqyc-dec")
    ...
    //         } else {
    //             var additionalClasses = isWeekend ? "jqyc-weekend" : "";
    //             monthHTMLString =
    //                 monthHTMLString +
